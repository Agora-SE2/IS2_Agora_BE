...
class OpinionsControllerTest < ActionController::TestCase
  ...
  test "should create opinion" do
    assert_difference('Opinion.count') do
      post :create, opinion: { content: @opinion.content, date: @opinion.date, like: @opinion.like, pro: @opinion.pro }
    end
  ...
  test "should update opinion" do
    patch :update, id: @opinion, opinion: { content: @opinion.content, date: @opinion.date, like: @opinion.like, pro: @opinion.pro }
    assert_redirected_to opinion_path(assigns(:opinion))
  end
